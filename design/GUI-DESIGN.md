...
*Note: an earlier draft of this document also sketched a second navigation paradigm (below) for a separate personal-assistant system's knowledge domains. That paradigm belongs to that separate system, not to this harness; it is retained here only as design context.*
